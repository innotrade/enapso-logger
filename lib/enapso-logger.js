...
class EnapsoLogger {
	...
	constructor() {
        ...
        this.console = {};
        this.console.debug = console.debug ? console.debug : console.log;
        this.console.info = console.info ? console.info : console.log;
        this.console.warn = console.warn ? console.warn : console.log;
        this.console.error = console.error ? console.error : console.log;
